          ...
          messages: [
              {
                  ...
                  content: [
                      {
                          type: "text",
                          text: "Provide an accurate description of the person shown in the image, detailing their facial features, skin tone, exact hair length and style (like if the hair covers the forehead or reaches the ears), eye color, facial structure, and visible clothing. This precise description is needed for replicating the image."
                      },
                      {
                          type: "image_url",
                          image_url: {
...
app.post('/generate-image', async (req, res, next) => {
  ...
  try {
    const dallePayload = {
      ...
      prompt: description, // Use the description as the prompt for the image generation
